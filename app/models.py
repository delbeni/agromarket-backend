...
class CourseTaxi(db.Model):
    ...
    def to_dict(self):
        return {
            ...
            "livreur_plaque": self.livreur.plaque_immatriculation if self.livreur else None,
            "livreur_couleur_vehicule": self.livreur.couleur_vehicule if self.livreur else None,
            "livreur_marque_vehicule": self.livreur.marque_vehicule if self.livreur else None,
            "client_nom": self.client_nom, "client_telephone": self.client_telephone,
